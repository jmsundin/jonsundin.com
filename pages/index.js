function HomePage() {
  return (
    <div className="flex flex-col gap-8 mx-auto p-5 md:w-4/5">
      <h1 className="text-white text-5xl mx-auto">Welcome!</h1>
      <div className="flex flex-col gap-8 sm:flex sm:flex-row">
        {/* Intro and About Me */}
        <div className="flex flex-col sm:flex-1 gap-8 text-white text-base md:text-xl">
          <div className="relative before:absolute before:top-0 before:bottom-0 before:w-0.5 before:bg-gradient-to-b before:from-gray-500 before:to-white">
            {" "}
            <p className="ml-4">
        ...
        <div className="relative flex flex-col sm:flex-1 gap-8 text-white text-base md:text-xl">
